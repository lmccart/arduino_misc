String cues_1p[22] = {
  "0wish", "0lie", "0reminisce", "0make eye contact", "0notice", "0plan", "0criticize", "0laugh", 
...
String cues_2p[66] = {
  ...
  "0argue", "1relate to", "0brag", "1care", "0challenge", "0make eye contact", "0advise", "1complain", 
...
String cues_3p[90] = {
  "0share", "1accuse", "2critize", "0lie", "1raise eyebrows", "1commiserate", "0reveal",
  ...
  "1advise", "2praise", "0aggravate", "1chime in", "2care", "0reminisce", "0raise eyebrows", "1quote", "0charm",
  "1relate to", "2digress", "0insult", "0clap", "1agree", "0criticize", "0make eye contact", "1notice", "0accuse", "1touch",
  ...
  "0dismiss", "0touch", "1make fun", "0wish", "1brag", "2respond", "0accuse", "0make eye contact", "1predict"};
String cues_4p[116] = {
  ...
  "1question", "2aggravate", "3care", "0brag", "0make eye contact", "1reveal", "2accuse", "0confront", "1wish",
  "2advise", "3use sarcasm", "0praise", "0raise eyebrows", "1defend", "2disagree", "0predict", "1interrupt",
  ...
  "2commiserate", "0relate to", "1challenge", "1make eye contact", "2care", "0reveal", "0smile", "1debate", "2praise",
...
void resetCues() {
  ...
  cues_out[0] = "0raise eyebrows"; //PEND
}
...
void handleCueOut() {
  ...
  if (cues_out[0].charAt(0)-48 == cur_cue) {
    ...
    Serial.print(remixCue(cues_out[0], db, 0));
    if (db) {
      Serial.print(0x7c, BYTE);
      Serial.print(0x19, BYTE);
      Serial.print(0x20, BYTE);  
      Serial.print(remixCue(cues_out[0], db, 1));  
    }
  }
  if (cues_out[1].charAt(0)-48 == cur_cue) {        
    ...
    Serial1.print(remixCue(cues_out[0], db, 0));
    if (db) {
      Serial1.print(0x7c, BYTE);
      Serial1.print(0x19, BYTE);
    ...
    Serial1.print(0x18, BYTE);
    Serial1.print(0x4, BYTE);   
      Serial1.print(remixCue(cues_out[0], db, 1));  
    }
  }
...
String werd, remix;
String remixCue(String c, boolean db, int part) {
  werd = "";
  remix = "";
  ...
  if (part == 0) {
    ...
    werd = c.substring(c.indexOf(" "), c.length()); 
  }
